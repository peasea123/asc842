...
\begin{tabular}{p{0.4cm}p{2.3cm}p{2.2cm}p{1.8cm}p{1.8cm}}
\toprule
\textbf{\#} & \textbf{Question} & \textbf{Method} & \textbf{Sample} & \textbf{Expected Result} \\
\midrule
\textbf{1} & Are book RE values irrelevant? & Fama-MacBeth cross-sectional & 8,000+ firm-years (1980--2024) & Book $\beta \approx 0$; Market $\beta > 0$ \\
\midrule
\textbf{2} & Would fair value change financials? & Fair value simulation + DiD (IFRS) & 300+ firms (2007--2009) & ROA $\downarrow$ 2--3 pp; Leverage $\uparrow$ \\
\midrule
\textbf{3} & Do RE divestitures create value? & Event study (CAR) + propensity matching & 2,000+ sales; 100 spin-offs & CAR = +0.5 to +1.0\% \\
\midrule
\textbf{4} & Do firms respond to RE shocks? & Difference-in-differences (regional) & 5,000+ firm-years (GFC/recessions) & Elasticity = 0.08--0.12 \\
\bottomrule
\end{tabular}
\end{table}
...
\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{p{1.8cm}p{2cm}p{2.3cm}p{1.3cm}}
\toprule
\textbf{Data Type} & \textbf{Source} & \textbf{Coverage} & \textbf{Notes} \\
\midrule
Corporate financials & Compustat (WRDS) & 1980--2024 & PPE, depreciation, debt \\
Stock returns & CRSP (WRDS) & Daily/monthly & For q, CAR calc. \\
RE prices (regional) & CoStar Real Capital & Q, 1990--2024 & 380+ US metros \\
RE prices (national) & NAREIT/Fed & Monthly, 1980--2024 & Robustness checks \\
Transaction data & SEC EDGAR (8-K) & All public firms & Event dates \\
\bottomrule
\end{tabular}
\end{table}
